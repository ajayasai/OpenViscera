...
## Retention, preservation, disposal and reassignment (v0.3)

The Lifecycle tab supports independently reviewed retention instructions, immediate specimen/case holds and reviewed release, proposal/approval/documentary completion of disposal, and reviewed examiner reassignment. Expiry never automatically disposes a specimen. Completion permanently closes physical actions without deleting evidence. Administrative certificate uploads are not clinical evidence or laboratory reports. Role/assignment/access checks and all operating limits are specified in [the v0.3 guide](V03-UPGRADE.md).
